...
function addon:InitSettings()
    if not LootPlusConfig then
        LootPlusConfig = table.deepcopy(addon.DEFAULTS) 
    else
        ...
        validate(addon.DEFAULTS, LootPlusConfig)
    end
end
...
function addon:IsReady()
    return LootPlusConfig and LootPlusConfig.loot and LootPlusConfig.combat and LootPlusConfig.colors and LootPlusConfig.notifications and LootPlusConfig.minimap
end
...
function addon:ResetDefaults()
    ...
    print("|cFF00FF00[Loot+]|r Settings reset to defaults.")
end